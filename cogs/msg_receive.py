                ...
                while not self.bot.is_closed():
                    ...
                    if line:
                        ...
                        if systemMatch and config.settings["showSystemMessages"]:
                            ...
                            # Profanity / filtered system words
                            if config.settings["censorEnabled"] and any(word in message.lower() for word in config.FILTERED_SYSTEM):
                            ...
                            presentTraits = [] # if any of the selected notifications are true, it will go here
                            ...
                            # Dend it if ANY matching category is enabled, otherwise it won't send for one being false
